# SE Hot Water &amp; Pergolas — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `sehotwater.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://sehotwater.netlify.app |
...
│   ├── cardinia.astro        # /south-east-melbourne/ (shire-wide overview)
...
├── whisper.js                # "Pete's Lead from SE Hot Water &amp; Pergolas" played to contractor before patching caller through
...
| `TENANT_BRAND` | `SE Hot Water &amp; Pergolas` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from SE Hot Water &amp; Pergolas."` |
...
3. Submit to Google Search Console (`sc-domain:sehotwater.com.au`).
4. Set up Google Business Profile (needs registered business name "SE Hot Water &amp; Pergolas" first).
5. Backlink work: hipages directory, True Local AU, Yelp AU, South East Melbourne community pages.
